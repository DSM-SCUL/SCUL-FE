...
import Save from "../../Assets/SVG/saveIcon.svg"
        ...
        <DetailContainer>
            ...
            <UsageMapContainer>
                <UserFeeWrapper>
                    ...
                    <Button style={{color: 'white', fontSize:'16px', cursor: 'pointer'}}>무료</Button>
                </UserFeeWrapper>
                <MapBox />
            </UsageMapContainer>
            <LinkWrapper>
                <div style={{fontSize: '14px', fontWeight: '500'}}>더 자세한 정보는 홈페이지 링크를 확인하세요!</div>
                <LinkWrap>https://github.com/wanteddev/wanted-sans/releases/tag/v1.0.3</LinkWrap>
            </LinkWrapper>
        </DetailContainer>
    )
}
